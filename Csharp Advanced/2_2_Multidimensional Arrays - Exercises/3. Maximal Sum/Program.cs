        ...
        static void Main(string[] args)
        {
            ...
            for (int row = 0; row < rows; row++)
            {
                for (int col = 0; col < cols; col++)
                {
                    ...
                    {
                        int sum = matrix[row, col] + matrix[row, col + 1] + matrix[row + 1, col] + matrix[row + 1, col + 1] + matrix[row + 2, col] + matrix[row, col + 2] + matrix[row + 2, col + 2] + matrix[row + 1, col + 2] + matrix[row + 2, col + 1];

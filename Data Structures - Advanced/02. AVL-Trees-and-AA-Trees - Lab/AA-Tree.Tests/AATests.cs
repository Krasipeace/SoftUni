...
public class AATests
{
    ...
    [Test]
    public void Delete_WithExistingElement_ShouldWorkCorrectly()
    {
        this.AATree.Delete(73);
        Assert.IsFalse(this.AATree.Contains(73));
        Assert.AreEqual(12, this.AATree.Count());
    }

    [Test]
    public void Delete_WithNonExistingElement_ShouldWorkCorrectly()
    {
        this.AATree.Delete(73);
        Assert.IsFalse(this.AATree.Contains(73));
        Assert.AreEqual(12, this.AATree.Count());

function calculatePyramidMaterials(base, increment) {
    ...
    function calculateMaterials(base) {
        while (base > 2) {
    ...
    function printResults(totalGold) {
    ...
    calculateMaterials(base);
    let totalGold = calculateGold(base);
    printResults(totalGold);
}
